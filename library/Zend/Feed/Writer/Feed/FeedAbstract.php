...
class Zend_Feed_Writer_Feed_FeedAbstract
{
    ...
    public function addAuthor($name, $email = null, $uri = null)
    {
        $author = array();
        if (is_array($name)) {
            if (!array_key_exists_wrapper('name', $name) || empty($name['name']) || !is_string($name['name'])) {
    ...
    {
        if (!array_key_exists_wrapper('copyright', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('lastBuildDate', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('generator', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('image', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('icon', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('language', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('link', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('feedLinks', $this->_data)) {
            return null;
        }
    ...
    {
        if (!array_key_exists_wrapper('hubs', $this->_data)) {
            return null;
        }
