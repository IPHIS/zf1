...
abstract class Zend_Translate_Adapter {
    ...
    public function __construct($options = array())
    {
        ...
        if (array_key_exists_wrapper('cache', $options)) {
    ...
    public function addTranslation($options = array())
    {
        ...
        if ((array_key_exists_wrapper('log', $options)) && !($options['log'] instanceof Zend_Log)) {
            require_once 'Zend/Translate/Exception.php';
    ...
    private function _addTranslationData($options = array())
    {
        ...
        foreach($keys as $key) {
            ...
            if (array_key_exists_wrapper($key, $temp) && is_array($temp[$key])) {
        ...
        if (!Zend_Locale::isLocale($locale, true, false)) {
            if (!Zend_Locale::isLocale($locale, false, false)) {
                ...
                if (!empty($this->_options['route'])) {
                    if (array_key_exists_wrapper($locale, $this->_options['route']) &&
                        !array_key_exists_wrapper($locale, $this->_routed)) {
