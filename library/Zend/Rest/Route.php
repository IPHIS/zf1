...
class Zend_Rest_Route extends Zend_Controller_Router_Route_Module
{
    ...
    public function assemble($data = array(), $reset = false, $encode = true)
    {
        ...
        if ($this->_moduleValid || array_key_exists_wrapper($this->_moduleKey, $data)) {
    ...
    protected function _checkRestfulModule($moduleName)
    {
        ...
        if ($this->_restfulControllers && array_key_exists_wrapper($moduleName, $this->_restfulControllers)) {
            return true;
        }
        return false;
    }
