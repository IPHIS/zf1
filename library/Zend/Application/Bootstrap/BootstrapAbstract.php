               ...
               Zend_Application_Bootstrap_ResourceBootstrapper
{
    ...
    public function setOptions(array $options)
    {
        ...
        if (array_key_exists_wrapper('pluginpaths', $options)) {
        ...
        if (is_array($array2)) {
            foreach ($array2 as $key => $val) {
                if (is_array($array2[$key])) {
                    $array1[$key] = (array_key_exists_wrapper($key, $array1) && is_array($array1[$key]))
    ...
    public function unregisterPluginResource($resource)
    {
        ...
        if (array_key_exists_wrapper($resource, $this->_pluginResources)) {
    ...
    {
        if (array_key_exists_wrapper(strtolower($resource), $this->_pluginResources)) {
            $resource = strtolower($resource);
    ...
    protected function _executeResource($resource)
    {
        ...
        if (array_key_exists_wrapper($resourceName, $classResources)) {
