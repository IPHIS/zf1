...
class Zend_Form_Element_Captcha extends Zend_Form_Element_Xhtml
{
    ...
    public function setCaptcha($captcha, $options = array())
    {
        if ($captcha instanceof Zend_Captcha_Adapter) {
            ...
            if (is_array($captcha)) {
                if (array_key_exists_wrapper('captcha', $captcha)) {
    ...
    public function setOptions(array $options)
    {
        ...
        if (array_key_exists_wrapper('captcha', $options)) {
            $captcha = $options['captcha'];
            if (array_key_exists_wrapper('captchaOptions', $options)) {
    ...
    public function render(Zend_View_Interface $view = null)
    {
        ...
        if (!$this->loadDefaultDecoratorsIsDisabled()) {
            ...
            if (!empty($decorator) && !array_key_exists_wrapper($key, $decorators)) {
            ...
            if ($captcha instanceof Zend_Captcha_Word && !array_key_exists_wrapper($key, $decorators)) {
                array_unshift($decorators, $decorator);
            }
    ...
    public function isValid($value, $context = null)
    {
        ...
        foreach ($segments as $segment) {
            if (array_key_exists_wrapper($segment, $newContext)) {
