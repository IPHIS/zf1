...
class Zend_Dojo_BuildLayer
{
    ...
    {
        return array_key_exists_wrapper((string) $key, $this->_profileOptions);
    }
    ...
    public function getProfilePrefixes()
    {
        ...
        if (null !== $layerName) {
            ...
            if (!array_key_exists_wrapper($prefix, $this->_profilePrefixes)) {
    ...
    public function generateBuildProfile()
    {
        ...
        if (!array_key_exists_wrapper('releaseName', $profileOptions)) {
