...
class Zend_Amf_Parse_Amf3_Serializer extends Zend_Amf_Parse_Serializer
{
    ...
    public function writeString(&$string)
    {
        ...
        $ref = array_key_exists_wrapper($string, $this->_referenceStrings)
    ...
    protected function writeObjectReference(&$object, $objectByVal = false)
    {
        ...
        $ref = array_key_exists_wrapper($hash, $this->_referenceObjects)
    ...
    public function writeObject($object)
    {
        ...
        if(array_key_exists_wrapper($className, $this->_referenceDefinitions)){
