...
class Zend_Controller_Router_Route extends Zend_Controller_Router_Route_Abstract
{
    ...
    public function match($path, $partial = false)
    {
        ...
        if ($path !== '') {
            ...
            foreach ($path as $pos => $pathPart) {
                ...
                if (!array_key_exists_wrapper($pos, $this->_parts)) {
                    if ($partial) {
                        break;
                    } else {
                        return false;
        ...
        foreach ($this->_variables as $var) {
            if (!array_key_exists_wrapper($var, $return)) {
                return false;
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        ...
        foreach ($this->_parts as $key => $part) {
            ...
            $useDefault = false;
            if (isset($name) && array_key_exists_wrapper($name, $data) && $data[$name] === null) {
                $useDefault = true;
            }
            ...
            if (isset($name)) {
                ...
                } elseif (array_key_exists_wrapper($name, $this->_defaults)) {
