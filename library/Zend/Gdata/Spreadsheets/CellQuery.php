...
class Zend_Gdata_Spreadsheets_CellQuery extends Zend_Gdata_Query
{
    ...
    {
        if (array_key_exists_wrapper('min-row', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('max-row', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('min-col', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('max-col', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('range', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('return-empty', $this->_params)) {
