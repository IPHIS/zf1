...
class Zend_Gdata_Query
{
    ...
    {
        if (array_key_exists_wrapper('alt', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('max-results', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('q', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('start-index', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('updated-max', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('updated-min', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('published-max', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('published-min', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('author', $this->_params)) {
