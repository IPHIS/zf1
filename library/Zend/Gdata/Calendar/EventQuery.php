...
class Zend_Gdata_Calendar_EventQuery extends Zend_Gdata_Query
{
    ...
    {
        if (array_key_exists_wrapper('start-max', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('start-min', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('orderby', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('sortorder', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('recurrence-expansion-start', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('recurrence-expansion-end', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('singleevents', $this->_params)) {
    ...
    {
        if (array_key_exists_wrapper('futureevents', $this->_params)) {
