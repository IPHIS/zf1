...
class Zend_Validate_File_Crc32Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testBasic()
    {
        ...
        $this->assertTrue(array_key_exists_wrapper('fileCrc32NotFound', $validator->getMessages()));
        ...
        $this->assertTrue(array_key_exists_wrapper('fileCrc32DoesNotMatch', $validator->getMessages()));
    }
