...
class Zend_Validate_File_HashTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testBasic()
    {
        ...
        $this->assertTrue(array_key_exists_wrapper('fileHashNotFound', $validator->getMessages()));
        ...
        $this->assertTrue(array_key_exists_wrapper('fileHashDoesNotMatch', $validator->getMessages()));
    }
