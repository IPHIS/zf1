...
class Zend_Validate_File_Md5Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testBasic()
    {
        ...
        $this->assertTrue(array_key_exists_wrapper('fileMd5NotFound', $validator->getMessages()));
        ...
        $this->assertTrue(array_key_exists_wrapper('fileMd5DoesNotMatch', $validator->getMessages()));
    }
